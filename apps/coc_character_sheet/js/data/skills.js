...
const SKILLS_DATA = {
  ...
  regular: {
    '会计': 5, '操作重型机械': 1, '考古学': 1,
    '信用评级': 0,
    // BUG-001: 克苏鲁神话已移至 SKILLS_DATA.cthulhuMythos，不在常规技能分配中出现
    // BUG-033: 动物驯养、催眠、潜水、爆破、炮术、读唇已移至 SKILLS_DATA.unconventional
  ...
  pilot: {},
  // BUG-001: 克苏鲁神话 — 创建时不可分配点数，仅通过游戏内遭遇增加
  cthulhuMythos: {
    '克苏鲁神话': 0
  },
  // BUG-033: 非常规技能 — 规则书标记为[非常规]，不会在标准角色卡上出现
  unconventional: {
