...
const EQUIPMENT_DATABASE = {
  ...
  '男装': [
    ...
    { name: '外套', price: 9.95, category: '男装' },
    ...
    { name: '密织棉布衬衫', price: 0.79, category: '男装' },
  ...
  '女装': [
    { name: '定制时装礼服', price: 90, category: '女装' },
    ...
    { name: '丝织灯笼裤', price: 3.98, category: '女装' },
  ...
  '住宿': [
    ...
    { name: '豪华宾馆', price: 30, category: '住宿' },
  ...
  '户外与旅行装备': [
    ...
    { name: '手电筒', price: 1.35, category: '户外与旅行装备' },
  ...
  '通讯': [
    ...
    { name: '明信片', price: 0.05, category: '通讯' },
  ...
  '航海': [
    ...
    { name: '四人热气球', price: 1800, category: '航海' },
  ...
  // ===== 武器（来自 weapons.md，仅保留 1920s 可用）=====

  '近战武器': [
    { name: '黄铜指虎', price: 1, category: '近战武器' },
    { name: '长鞭', price: 5, category: '近战武器' },
    { name: '燃烧的火把', price: 0.05, category: '近战武器' },
    { name: '包革金属棒（大头棍、护身棒）', price: 2, category: '近战武器' },
    { name: '大型棍棒（棒球棒、板球棒、拨火棍）', price: 3, category: '近战武器' },
    { name: '小型棍棒（警棍）', price: 3, category: '近战武器' },
    { name: '弩', price: 10, category: '近战武器' },
    { name: '绞索', price: 0.50, category: '近战武器' },
    { name: '手斧/镰刀', price: 3, category: '近战武器' },
    { name: '大型刀具（骑兵军刀等）', price: 4, category: '近战武器' },
    { name: '中型刀具（切肉刀等）', price: 2, category: '近战武器' },
    { name: '小型刀具（折叠刀等）', price: 2, category: '近战武器' },
    { name: '双节棍', price: 1, category: '近战武器' },
    { name: '投石', price: 0, category: '近战武器' },
    { name: '手里剑', price: 0.50, category: '近战武器' },
    { name: '矛（骑枪）', price: 25, category: '近战武器' },
    { name: '大型刀剑（马刀）', price: 30, category: '近战武器' },
    { name: '中型刀剑（长剑、重剑）', price: 15, category: '近战武器' },
    { name: '轻型刀剑（花剑、剑杖）', price: 25, category: '近战武器' },
    { name: '伐木斧', price: 5, category: '近战武器' },
    { name: '西洋剑', price: 12.50, category: '近战武器' },
    { name: '刺刀', price: 3.75, category: '近战武器' },
    { name: '匕首', price: 2.50, category: '近战武器' },
    { name: '直刃剃刀', price: 0.65, category: '近战武器' },
    { name: '铜指虎', price: 1.00, category: '近战武器' },
    { name: '警棍（30cm）', price: 1.98, category: '近战武器' },
    { name: '马鞭', price: 0.60, category: '近战武器' },
    { name: '4磅伐木斧', price: 1.95, category: '近战武器' },
    { name: '5米牛鞭', price: 1.75, category: '近战武器' },
  ],

  '手枪': [
    { name: '.22 自动手枪', price: 25, category: '手枪' },
    { name: '.25 德林杰手枪（单管）', price: 12, category: '手枪' },
    { name: '.32/7.65mm 左轮手枪', price: 15, category: '手枪' },
    { name: '.32/7.65mm 自动手枪', price: 20, category: '手枪' },
    { name: '.38/9mm 左轮手枪', price: 25, category: '手枪' },
    { name: '.38/9mm 自动手枪', price: 30, category: '手枪' },
    { name: '9mm 鲁格 P08', price: 75, category: '手枪' },
    { name: '.41 左轮手枪', price: 30, category: '手枪' },
    { name: '.45 左轮手枪', price: 30, category: '手枪' },
    { name: '.45 自动手枪', price: 40, category: '手枪' },
  ],

  '步枪': [
    { name: '.22 栓动步枪', price: 13, category: '步枪' },
    { name: '.30 杠杆步枪', price: 19, category: '步枪' },
    { name: '.45 马蒂尼-亨利步枪', price: 20, category: '步枪' },
    { name: '莫兰上校的气动步枪', price: 200, category: '步枪' },
    { name: '.303 李-恩菲尔德步枪', price: 50, category: '步枪' },
    { name: '.30-06(7.62mm) 栓动步枪', price: 75, category: '步枪' },
    { name: '双管猎象枪', price: 400, category: '步枪' },
  ],

  '霰弹枪': [
    { name: '20号双管霰弹枪', price: 35, category: '霰弹枪' },
    { name: '16号双管霰弹枪', price: 40, category: '霰弹枪' },
    { name: '12号双管霰弹枪', price: 40, category: '霰弹枪' },
    { name: '12号双管霰弹枪（锯短枪管）', price: 0, category: '霰弹枪' },
  ],

  '冲锋枪': [
    { name: '贝格曼 MP18/MP28', price: 1000, category: '冲锋枪' },
    { name: '汤普森冲锋枪', price: 200, category: '冲锋枪' },
  ],

  '机枪': [
    { name: '1882年式手摇加特林', price: 2000, category: '机枪' },
    { name: 'M1918 勃朗宁自动步枪', price: 800, category: '机枪' },
    { name: '勃朗宁 M1917A1 (.30-06/7.62mm)', price: 3000, category: '机枪' },
    { name: '布伦轻机枪', price: 3000, category: '机枪' },
    { name: '刘易斯 MK.I 型机枪', price: 3000, category: '机枪' },
    { name: '维克斯 .303 机枪', price: 0, category: '机枪' },
  ],

  '爆炸物': [
    { name: '莫洛托夫鸡尾酒', price: 0, category: '爆炸物' },
    { name: '信号枪', price: 15, category: '爆炸物' },
    { name: '炸药棒', price: 2, category: '爆炸物' },
    { name: '雷管', price: 1, category: '爆炸物' },
    { name: '管状土制炸弹', price: 0, category: '爆炸物' },
    { name: '手榴弹', price: 0, category: '爆炸物' },
    { name: '75mm 野战炮', price: 1500, category: '爆炸物' },
    { name: '火焰喷射器', price: 0, category: '爆炸物' },
  ],

  '弹药': [
    { name: '.22 长步枪弹（500发）', price: 21, category: '弹药' },
    { name: '.25 自动手枪子弹（50发）', price: 15, category: '弹药' },
    { name: '.30 卡宾枪弹（50发）', price: 15, category: '弹药' },
    { name: '.30-06 春田式步枪弹（50发）', price: 15, category: '弹药' },
    { name: '.38 Special（50发）', price: 17, category: '弹药' },
    { name: '.45 自动手枪子弹（100发）', price: 23, category: '弹药' },
    { name: '10号霰弹（25发）', price: 40, category: '弹药' },
    { name: '12号霰弹（25发）', price: 30, category: '弹药' },
    { name: '16号霰弹（25发）', price: 26, category: '弹药' },
    { name: '20号霰弹（25发）', price: 28, category: '弹药' },
  ],
  },
  '现代': {
    // ===== 现代装备（严格按 wiki 数据） =====
    '男装': [
      { name: '定制真丝正装', price: 1000, category: '男装' },
      ...
      { name: '防弹背心', price: 600, category: '男装' },
    ],
    '女装': [
      { name: '设计师定制礼服（上身一次）', price: 500, category: '女装' },
      ...
      { name: '防弹背心', price: 600, category: '女装' },
    ],
    '住宿': [
      { name: '经济型汽车旅馆', price: 40, category: '住宿' },
      { name: '一般旅馆', price: 90, category: '住宿' },
      { name: '每周（带服务）', price: 500, category: '住宿' },
      { name: '高级旅馆', price: 200, category: '住宿' },
      { name: '大酒店', price: 600, category: '住宿' },
      { name: '房子（年租）', price: 20000, category: '住宿' },
      { name: '公寓（周租）', price: 350, category: '住宿' },
    ],
    '医疗用品': [
    ...
    '电子器材': [
      ...
      { name: '隐蔽录音设备', price: 300, category: '电子器材' },
      { name: '窃听设备', price: 200, category: '电子器材' },
      { name: '夜视仪', price: 600, category: '电子器材' },
    ],
    '工具': [
    ...
    '计算机': [
      { name: '廉价 PC', price: 100, category: '计算机' },
      { name: '笔记本电脑', price: 400, category: '计算机' },
      { name: '高级 PC', price: 1500, category: '计算机' },
      { name: '高级笔记本', price: 1300, category: '计算机' },
      { name: '平板电脑', price: 400, category: '计算机' },
      { name: '邮件管理软件', price: 200, category: '计算机' },
    ],
    '旅行': [
      { name: '机票（每10km）', price: 6, category: '旅行' },
      { name: '国际航班（每100km）', price: 17.5, category: '旅行' },
      { name: '75km 火车', price: 6.25, category: '旅行' },
      { name: '200km 火车', price: 12.5, category: '旅行' },
      { name: '1000km 火车', price: 62.5, category: '旅行' },
      { name: '头等舱（单程）航海', price: 3500, category: '旅行' },
      { name: '标准舱（单程）航海', price: 1600, category: '旅行' },
      { name: '货船运费', price: 1400, category: '旅行' },
    ],
    '枪械弹药': [
    ...
    '战斗装备': [
      { name: '非法消音器（手枪）', price: 1000, category: '战斗装备' },
      { name: '激光瞄准器', price: 300, category: '战斗装备' },
      { name: '光学瞄准镜', price: 200, category: '战斗装备' },
      { name: '手持电击器', price: 50, category: '战斗装备' },
      { name: '电击警棍', price: 65, category: '战斗装备' },
      { name: '辣椒喷雾剂', price: 16, category: '战斗装备' },
      { name: '铝指虎', price: 20, category: '战斗装备' },
      { name: '复合弩', price: 600, category: '战斗装备' },
