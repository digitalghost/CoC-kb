...
// 注意: 原 Step 6（衍生属性）已移除，衍生属性在最终角色卡中展示
...
function renderStep() {
  ...
  switch (state.currentStep) {
    ...
    // 原 case 5 (renderStep6 衍生属性) 已移除
    case 5: renderStep7(container); break;
    case 6: renderStep8(container); break;
    case 7: renderStep9(container); break;
  }
}
